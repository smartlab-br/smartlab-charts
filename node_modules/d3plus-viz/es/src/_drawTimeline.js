...
function setTimeFilter(s) {
  ...
  if (JSON.stringify(s) !== JSON.stringify(this._timelineSelection)) {
    ...
    this.timeFilter(function (d) {
      var ms = date(this$1._time(d)).getTime();
...
export default function(data) {
  ...
  var ticks = timelinePossible ? Array.from(new Set(this._data.map(this._time))).map(date) : [];
  ...
  if (timelinePossible) {
    ...
    if (this._timelineSelection === void 0) {
      ...
      var dates = extent(data.map(this._time).map(date));
...
//# sourceMappingURL=_drawTimeline.js.map